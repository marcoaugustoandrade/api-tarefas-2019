...
route.get('/d?', apiController.verificar, tarefaValidation.listarPorDt, tarefaController.listarPorDt)
route.get('/:id', apiController.verificar, tarefaController.listarPorId)
